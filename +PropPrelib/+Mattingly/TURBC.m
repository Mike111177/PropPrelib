...
T_t4p5 = Tt4p5R;
while true % Label 1
    [T4p5, P4p5, MFP4p5] = MASSFP(Tt4p5, f4p5, M4p5);
    Pi_tH = (mdot4p5/mdot4)*(MFP4/MFP4p5)*A4dA4p5*sqrt(Tt4p5/Tt4);
    [~, ht4p5, Prt4p5, phit4p5, Cpt4p5, Rt4p5, gammat4p5, at4p5] = FAIR(1, f4p5, Tt4p5);
